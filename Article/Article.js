...
function createComponent(title, date, para1, para2, para3) {
    ...
    parentDiv.appendChild(h2Title);
    parentDiv.appendChild(pTagDate);
    parentDiv.appendChild(pTag1);
    parentDiv.appendChild(pTag2);
    parentDiv.appendChild(pTag3);
    parentDiv.appendChild(spanButton);
    ...
    pTagDate.textContent = date;
    pTag1.textContent = para1;
    pTag2.textContent = para2;
    pTag3.textContent = para3;
